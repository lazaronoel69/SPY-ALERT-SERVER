...
3. **TWELVEDATA_KEY y FINNHUB_KEY siguen hardcodeados** como strings literales en server.py (no en variable de entorno) — riesgo de seguridad menor, servicios no esenciales según v8.17.
